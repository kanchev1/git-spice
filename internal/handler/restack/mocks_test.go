...
// RestackMethod mocks base method.
func (m *MockService) RestackMethod() spice.RestackMethod {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RestackMethod")
	ret0, _ := ret[0].(spice.RestackMethod)
	return ret0
}

// RestackMethod indicates an expected call of RestackMethod.
func (mr *MockServiceMockRecorder) RestackMethod() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RestackMethod", reflect.TypeOf((*MockService)(nil).RestackMethod))
}
...
// BeginMergeAutostash mocks base method.
func (m *MockAutostashHandler) BeginMergeAutostash(ctx context.Context, method spice.RestackMethod, opts *autostash.Options) (func(*error), error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BeginMergeAutostash", ctx, method, opts)
	ret0, _ := ret[0].(func(*error))
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// BeginMergeAutostash indicates an expected call of BeginMergeAutostash.
func (mr *MockAutostashHandlerMockRecorder) BeginMergeAutostash(ctx, method, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BeginMergeAutostash", reflect.TypeOf((*MockAutostashHandler)(nil).BeginMergeAutostash), ctx, method, opts)
}
